...
- Print could be lost when the `pagebreak_split_block` setting was enabled. #TINY-3388
...
- Fixed changing a tables row from `ActionBar` to `Body` incorrectly moving the row to the bottom of the table. #TINY-4593
