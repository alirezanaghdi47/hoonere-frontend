...
export const ReceptionCard = ({reception, onDelete}) => {
    return (
        <div className="col-12 col-md-6">
            <div
                className="position-relative d-flex flex-column justify-content-between align-items-center gap-5 w-100 h-75px bg-light rounded-2 p-5">
...
const Receptions = ({createProjectAfficheP2Form, changeCurrentPart}) => {
    return (
                    ...
                    <div className="col-12">
                        <div className='d-flex flex-column justify-content-center align-items-start gap-2 w-100'>
                            ...
                            <div className='row g-5 w-100'>
                                {
                                    createProjectAfficheP2Form.values.receptions?.map((reception, i) =>
                                        <ReceptionCard
                                            key={i}
                                            reception={reception}
                                            onDelete={() => createProjectAfficheP2Form.setFieldValue("receptions", createProjectAfficheP2Form.values.receptions.filter((item, j) => i !== j))}
                                        />
                                    )
                                }
