...
export const ReceptionCard = ({reception, createProjectAfficheP2Form}) => {
    return (
        <div className="col-12 col-md-6">
            <div
                ...
                <IconButton
                    color="light-danger"
                    size="sm"
                    onClick={() => createProjectAfficheP2Form.setFieldValue("receptions", createProjectAfficheP2Form.values.receptions.filter(item => item.member_id !== reception.member_id))}
