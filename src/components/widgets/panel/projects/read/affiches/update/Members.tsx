...
export const MemberCard = ({member, updateProjectAfficheP2Form}) => {
    return (
        <div className="col-12 col-md-6">
            <div
                ...
                <IconButton
                    color="light-danger"
                    size="sm"
                    onClick={() => updateProjectAfficheP2Form.setFieldValue("members", updateProjectAfficheP2Form.values.members.filter(item => item.member_id !== member.member_id))}
