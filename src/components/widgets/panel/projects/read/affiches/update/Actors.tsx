...
export const ActorCard = ({actor, updateProjectAfficheP2Form}) => {
    return (
        <div className="col-12 col-md-6">
            <div
                ...
                <IconButton
                    color="light-danger"
                    size="sm"
                    onClick={() => updateProjectAfficheP2Form.setFieldValue("actors", updateProjectAfficheP2Form.values.actors.filter(item => item.actor_id !== actor.actor_id))}
...
const Actors = ({updateProjectAfficheP2Form, changeCurrentPart}) => {
    return (
