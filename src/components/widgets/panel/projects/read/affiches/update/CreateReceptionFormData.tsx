...
const CreateReceptionFormData = ({updateProjectAfficheP2Form, resetPart}) => {
    ...
    const createProjectAfficheReceptionForm = useFormik({
        initialValues: {
            member_id: "",
            reception_type: "",
        },
        ...
        onSubmit: async (result) => {
            ...
            updateProjectAfficheP2Form.setFieldValue("receptions", [
    ...
    useEffect(() => {
        if (createProjectAfficheUserForm.values.foa_parent_id) {
            ...
            createProjectAfficheReceptionForm.setFieldValue("member_id", "");
        }
            ...
            <div className="card-body d-flex flex-column justify-content-center align-items-center gap-5">
                    ...
                    <div className="col-lg-8">
                        <Form.Group>
                            <SelectBox
                                id="member_id"
                                name="member_id"
                                value={createProjectAfficheReceptionForm.values.member_id}
                                ...
                                isSearchable
                                disabled={!createProjectAfficheUserForm.values.foa_parent_id}
                                onChange={(value) => createProjectAfficheReceptionForm.setFieldValue("member_id", value)}
                                isLoading={readAllProjectMembersByFoaAction.isPending}
                            />

                            <Form.Error
                                error={createProjectAfficheReceptionForm.errors.member_id}
                                touched={createProjectAfficheReceptionForm.touched.member_id}
                            />
                        </Form.Group>
                    </div>
                </div>
                    ...
                    <div className="col-lg-8">
                        <Form.Group>
                            <SelectBox
                                id="reception_type"
                                name="reception_type"
                                value={createProjectAfficheReceptionForm.values.reception_type}
                                ...
                                isSearchable
                                onChange={(value) => createProjectAfficheReceptionForm.setFieldValue("reception_type", value)}
                                isLoading={readAllReceptionTypeAction.isPending}
                            />

                            <Form.Error
                                error={createProjectAfficheReceptionForm.errors.reception_type}
                                touched={createProjectAfficheReceptionForm.touched.reception_type}
                            />
                        </Form.Group>
                    </div>
                </div>
                ...
                <div className="row gy-5 w-100">
                    <div className="col-12 d-flex justify-content-end align-items-center gap-5">
                        <Button
                            color="light-danger"
                            onClick={() => createProjectAfficheReceptionForm.handleReset(createProjectAfficheReceptionForm)}
                        >
                            انصراف
                        </Button>
