...
// components
import {Contract, Article} from "@/components/widgets/panel/projects/read/contracts/supplements/create/Actions.tsx";
import CreateRegularFormData from "@/components/widgets/panel/projects/read/contracts/supplements/create/CreateRegularFormData.tsx";
...
// utils
import {removeArticleForSupplement} from "@/utils/functions.ts";
    ...
    return (
        <>
                                                    ...
                                                    <div className='ms-auto'>
                                                        <IconButton
                                                            ...
                                                            onClick={(e) => {
                                                                ...
                                                                const data = removeArticleForSupplement(createProjectContractForm.values.articles, createProjectContractForm.values.sections, article.number);
            ...
            <div className="d-flex justify-content-end align-items-center gap-5 w-100">
                <Button
                    href={auth.panel_url + `projects/${params.id}/contracts/${params.subId}/supplements`}
                    color="light-danger"
                >
                    انصراف
                </Button>
