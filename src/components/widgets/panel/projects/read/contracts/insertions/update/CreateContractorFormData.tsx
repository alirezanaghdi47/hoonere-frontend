...
const CreateContractorFormData = ({article , section , updateProjectContractInsertionForm}) => {
    const {
        part: sectionPart,
        ...
        >
            <div className='d-flex justify-content-start align-items-center gap-5 w-100'>
                ...
                <ul className="vstack justify-content-center gap-5 p-0 m-0">
                    {
                        updateProjectContractInsertionForm.values.articles.find(item => item.number === article.number)?.contractors?.map(contractor => {
                            // رسمی و حقیقی
