...
const ResumeForm = ({myProfileAction , updateOccupationForm}) => {
    return (
                ...
                <div className="row gy-2">
                    ...
                    <div className="col-lg-8">
                        <Form.Group>
                            <FileInput
                                name="resume_file"
                                preview={myProfileAction?.data?.data?.userInfo?.resume_file}
...
const Resume = ({myProfileAction ,updateOccupationForm , updateOccupationAction}) => {
    return (
        <>
            <ResumeForm
